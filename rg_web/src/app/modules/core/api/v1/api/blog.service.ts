...
import {
    ...
    BlogPostsWidthRetrieveRequestParams
...
export class BlogService extends BaseService implements BlogServiceInterface {
     ...
     * @param options additional options
     */
    public blogPostsWidthRetrieve(requestParameters: BlogPostsWidthRetrieveRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'image/webp', context?: HttpContext, transferCache?: boolean}): Observable<Post>;
    public blogPostsWidthRetrieve(requestParameters: BlogPostsWidthRetrieveRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'image/webp', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Post>>;
    public blogPostsWidthRetrieve(requestParameters: BlogPostsWidthRetrieveRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'image/webp', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Post>>;
    public blogPostsWidthRetrieve(requestParameters: BlogPostsWidthRetrieveRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'image/webp', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        const id = requestParameters?.id;
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling blogPostsWidthRetrieve.');
        }
        const width = requestParameters?.width;
        if (width === null || width === undefined) {
            throw new Error('Required parameter width was null or undefined when calling blogPostsWidthRetrieve.');
        }
        ...
        let localVarPath = `/blog/posts/${this.configuration.encodeParam({name: "id", value: id, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: undefined})}/width/${this.configuration.encodeParam({name: "width", value: width, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Post>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
