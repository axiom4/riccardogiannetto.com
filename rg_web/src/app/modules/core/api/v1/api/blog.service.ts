...
export class BlogService extends BaseService implements BlogServiceInterface {
   ...
   * @param options additional options
   */
  public blogPostsWidthRetrieve(
    requestParameters: BlogPostsWidthRetrieveRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
  ...
  public blogPostsWidthRetrieve(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling blogPostsWidthRetrieve.',
      );
    }
    const width = requestParameters?.width;
    if (width === null || width === undefined) {
      throw new Error(
        'Required parameter width was null or undefined when calling blogPostsWidthRetrieve.',
      );
    }
