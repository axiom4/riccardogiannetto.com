...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("downloading GeoIP database... this might take a minute.")
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f"Successfully downloaded GeoIP database to {dest_path}"))
            
        except Exception as e:
            self.stderr.write(self.style.ERROR(f"Failed to download database: {e}"))
