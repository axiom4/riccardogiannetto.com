...
FORCE_SCRIPT_NAME = os.environ.get('FORCE_SCRIPT_NAME', '/api')
...
MARTOR_UPLOAD_PATH = 'editor/{}'.format('uploads/')
...
IMAGE_GENERATOR_BASE_URL = f"{FORCE_SCRIPT_NAME.rstrip('/')}/portfolio/images"
